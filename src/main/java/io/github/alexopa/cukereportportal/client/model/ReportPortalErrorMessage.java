 ...
 *
 */
package io.github.alexopa.cukereportportal.client.model;
...
/**
 * Class that models an error message returned from the
 * {@link ReportPortalClient} in case an error happens on a request
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
@Builder
public class ReportPortalErrorMessage {
